...
<html lang="en">
   ...
   <body>
      <div class="container">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               ...
               <div class="collapse navbar-collapse" id="navbarNavDropdown">
                  <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="/cert-questions-answers.html">Practice Tests</a>
                     </li>
                     <li class="nav-item">
                        <a class="nav-link" href="/study-guide-uipath.html">UiPath Study Guide</a>
                     </li>
                     <li class="nav-item">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                           <a class="dropdown-item" href="/youtube-linkedin-twitter.html#twitter-uipath">Twitter</a>
                           <a class="dropdown-item" href="/youtube-linkedin-twitter.html#youtube-uipath">YouTube</a>
                           <a class="dropdown-item" href="/youtube-linkedin-twitter.html#linkedin-uipath">LinkedIn</a>
                        </div>
                     </li>
                  </ul>
               </div>
         ...
         <div class="row">
            <article class="main col col-12 col-sm-12  col-md-8 col-lg-9 order-1 order-sm-1 order-lg-1 mt-3">
               <!--
			   <div class="card">
            ...
            <aside  class="aside-2 col col-12  col-sm-12  col-md-4 col-lg-3 order-2 order-sm-2 order-lg-2 mb-3">
               <div class="card my-3" >
                  <div class="card-header">
                     <h4>New UiPath Certification Exams!</h4>
                  </div>
                  <picture>
                     <source srcset="/assets/uipath-exam-questions-answers.gif" media="(min-width: 1200px)">
                     <source srcset="/assets/uipath-exam-questions-answers.gif" media="(min-width: 992px)">
                     <source srcset="/assets/uipath-exam-questions-answers.gif" media="(min-width: 768px)">
                     <source srcset="/assets/practice.jpg" media="(min-width: 576px)">
                     <img src="/assets/practice.jpg" class="img-fluid">
                  </picture>
                  <div class="card-body">
                     <h4 class="card-title">Our toughest set of advanced UiPath question and answer tests.</h4>
                     <p class="card-text">Are you up for the challenge?</p>
                     <a href="/cert-questions-answers.html" class="btn btn-primary btn-sm">UiPath Mock Exams</a>
                  </div>
               </div>
               <div class="card my-2" >
                  <div class="card-header">
                     <h4 >Get Certified Fast</h4>
                  </div>
                  <div class="card-body">
                     <h4 class="card-title mt-2 text-center">Follow our proven <a href="/study-guide-uipath.html">study plan</a>.</h4>
                     <p class="card-text text-center">Make this badge your own.</p>
               ...
               <div class="card my-2">
                  ...
                  <div class="card-body">
                     <p class="card-text">Follow me, Serge Salerno, and my UiPath friends on social media.</p>
                     <ul class="nav flex-column">
                        <li class="nav-item">
                           ...
                           <a href="/youtube-linkedin-twitter.html#twitter-uipath">Twitter</a>
                        </li>
                        <li class="nav-item">
                           ...
                           <a href="/youtube-linkedin-twitter.html#youtube-uipath">YouTube</a>
                        </li>
                        <li class="nav-item">
                           ...
                           <a href="/youtube-linkedin-twitter.html#youtube-linkedin">LinkedIn</a>
                        </li>
                        <li class="nav-item">
