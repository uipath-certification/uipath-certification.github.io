...
<figure class="figure">
  ...
  <figcaption class="figure-caption">This image of an RPA robot is part of the UiPath Trademark application for 'UI.' Notice the 'UI' text under the left eye? The use here is purely informative and is intended only as fair use, as it is pertinent to the article. We are in no way associated with UiPath. We just really like their stuff.</figcaption>
</figure>
