...
author: Jenny
title: "UiPath Associate vs Developer Certification Compared"
...
<table  class="table table-light table-striped table-bordered border-secondary">
  ...
  <thead class="table table-primary" >
	<tr>
		<td colspan="3" class="table-dark"><center><h2>UiPath Associate or Developer Certification Comparison Chart</h2></center></td>
</tr>	
    <tr>
      <td>Criteria</td>
